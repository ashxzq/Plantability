...
public class MyPlots_6x8_Base extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_plots_6x8_base);
    ...
    public void onClick(View v) {
        ...
        if (v.getId() == R.id.lighting_button_layout) {
            ...
            if (!contains_plant) {
                Toast.makeText(MyPlots_6x8_Base.this, "Currently in viewing plot mode.", Toast.LENGTH_SHORT).show();
            }
        }
    }
