...
public class MyPlants_AddPlant4 extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_plants_add_plant_4);
        ...
        if (intentSunLevel != null) {
            sunLevelInput.setText(intentSunLevel);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), MyPlants_AddPlant5.class);
                intent.putExtras(previousExtras);

                String sunLevel = sunLevelInput.getText().toString();
