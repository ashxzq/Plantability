...
public class MyPlots_4x4_RemovePlant extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_plots_4x4_remove_plant);
        ...
        if (v.getId() == R.id.view_button_layout) {
            ...
            for (int i = 0; i < tileIds.length; i++) {
                ...
                if (v.getId() == tileId) {
                    ...
                    Intent intent = new Intent(getApplicationContext(), MyPlots_4x4_RemovePlant.class);
                    intent.putExtra("plot_name", plotName);
                    startActivity(intent);
                    finish();
                    break;
